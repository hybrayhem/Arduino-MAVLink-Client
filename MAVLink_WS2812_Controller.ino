...
#define BRIGHTNESS  255      //LED\/  // Put 0 to switch off all leds


// For led chips like Neopixels, which have a data line, ground, and power, you just
// need to define DATA_PIN.  For led chipsets that are SPI based (four wires - data, clock,
// ground, and power), like the LPD8806 define both DATA_PIN and CLOCK_PIN
#define DATA_PIN 2    //LED\/
//#define MODE_PIN 3
//#define CLOCK_PIN 13
...
CRGB led_off[NUM_MODOS][NUM_LEDS] = {    //LED\/
  // Mode 0
  {
  CRGB::Blue,    // Static
  CRGB::Black,   // Static
...
void setup() {
  ...
  FastLED.addLeds<WS2811, DATA_PIN, GRB>(leds, NUM_LEDS);    //LED\/
  FastLED.setBrightness( BRIGHTNESS );    //LED\/
...
void loop() {
  ...
  if (currentMillis - previousMillis >= next_interval) {
    ...
    leds_status++;    //LED\/
    if(leds_status >= 4) leds_status=0;    //LED\/
